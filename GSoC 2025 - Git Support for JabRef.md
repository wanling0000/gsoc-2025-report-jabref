...
| **Organization**       | [JabRef e.V.](https://verein.jabref.org/)                                                                                                                                                |
...
To support version control and collaborative editing of BibTeX libraries, this project adds Git integration to JabRef and introduces a semantic merge mechanism to improve the merging experience.
...
In the scope of the project, the possible semantic merge scenarios of BibTeX files (with their respective BibTeX entries) was developed.
Based on this, test scenearios have been crafted and manifested as JUnit test cases.
...
- [#13775](https://github.com/JabRef/jabref/pull/13775) - Restore local-only Git behavior for SLR to fix repository initialization error. Fixes a regression where the `GitHandler.pullOnCurrentBranch()` method was modified to support remote repositories.
...
- I gained a deeper understanding of how Git works internally, and how to programmatically interact with Git repositories using [JGit](https://github.com/eclipse-jgit/jgit).
